<div wire:init="loadPost">
    ...
    @else
    <div class="mb-4 h-48 flex justify-center items-center bg-white shadow-x1 border-gray-100 rounded-lg">
        <svg class="inline mr-2 w-12 h-12 text-gray-200 animate-spin fill-pink-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
