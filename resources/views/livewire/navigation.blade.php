...
<header class="bg-gray-700 sticky top-0 z-50" x-data="dropdown()">
    {{-- Care about people's approval and you will be their prisoner. --}}
        ...
        <div class="container flex items-center h-16 justify-between md:justify-start">
                ...
                <a x-on:click="show()"
                class="flex flex-col items-center justify-center order-last md:order-first px-4 md:px6 bg-white bg-opacity-25 text-white font-semibold h-full cursor-pointer">
...
class="bg-gray-700 bg-opacity-25 w-full absolute hidden" id="navigation-menu">
        ...
        <div class="grid grid-cols-4 h-full relative">
            <ul class="bg-white">
                @foreach ($categories as $category)
                    <li class="navigation-link text-gray-500 hover:bg-indigo-700 hover:text-white">
    ...
    <div class=" bg-white h-full overflow-y-auto">
        ...
        <p class="text-gray-500 px-6 text-sm flex items-center">Users</p>
        @auth
            <a href="{{route("profile.show")}}" class="py-2 px-6 text-sm flex items-center text-gray-500 hover:bg-indigo-700 hover:text-white">
            ...
            class="py-2 px-6 text-sm flex items-center text-gray-500 hover:bg-indigo-700 hover:text-white">
                <span class="justify-center w-9 flex">
        ...
        @else
            <a href="{{route("login")}}" class="py-2 px-6 text-sm flex items-center text-gray-500 hover:bg-indigo-700 hover:text-white">
                <span class="justify-center w-9 flex">
                    <i class="fa fa-user-check"></i>
                </span>
                Login
            </a>
            <a href="{{route("register")}}" class="py-2 px-6 text-sm flex items-center text-gray-500 hover:bg-indigo-700 hover:text-white">
                <span class="justify-center w-9 flex">
